...
public class MainActivity extends FragmentActivity implements
	...
	private void createDrawer() {
		...
		_drawerAdapter
				.setOnRowClickListener(new MoneyboxAdapter.OnRowClickListener() {
					public void onClick(int position) {
						selectMoneybox((Moneybox) _drawerAdapter
								.getItem(position));
					}
				});

		_drawerAdapter
				.setCurrentMoneyboxId(Preferences.getLastMoneyboxId(this));
		...
		_drawerToggle = new ActionBarDrawerToggle(this, _drawerLayout,
			...
			public void onDrawerOpened(View drawerView) {
				...
				getActionBar().setTitle(
						getString(R.string.moneybox_select_moneybox));
	...
	public void updateTotal() {
		...
		total.setText(CurrencyManager.formatAmount(MovementsManager
				.getTotalAmount(_drawerAdapter.getCurrentItem())));
	}
	...
	public void onHammerClicked() {
		...
		dlg.show(getSupportFragmentManager(), "breakMoneybox");
	}
	...
	public void onAddMoneyboxClicked() {
		...
		dlg.show(getSupportFragmentManager(), "addMoneybox");
	}
	...
	public void onDelMoneyboxClicked() {
		if (_drawerAdapter.getCount() == 1) {
			...
			t = Toast.makeText(this, R.string.msg_last_moneybox,
					Toast.LENGTH_LONG);
			t.show();
		} else {
			ConfirmDialog dlg;
			...
			dlg.show(getSupportFragmentManager(), "deleteMoneybox");
		}
	}
	...
	public void onEditMoneyboxClicked() {
		...
		dlg.show(getSupportFragmentManager(), "editMoneybox");
	}
	...
	private void updateMoneyboxesTotal() {
		...
		total.setText(CurrencyManager.formatAmount(_drawerAdapter
				.getTotalAmount()));
	}
